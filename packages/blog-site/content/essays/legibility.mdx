...
[^syntropic]: ["Syntropic137"](https://github.com/Syntropic137). *GitHub*. Agent engineering framework. Repository not yet public.
[^3]: Miller, George A. (1956). ["The Magical Number Seven, Plus or Minus Two"](https://en.wikipedia.org/wiki/The_Magical_Number_Seven,_Plus_or_Minus_Two). *Psychological Review*. Human working memory holds ~7 ± 2 chunks.
[^4]: Dastin, Jeffrey (2018). ["Amazon scrapped AI recruiting tool that showed bias against women"](https://www.reuters.com/article/us-amazon-com-jobs-automation-insight-idUSKCN1MK08G). *Reuters*.
[^5]: ["Dutch childcare benefits scandal"](https://en.wikipedia.org/wiki/Dutch_childcare_benefits_scandal). *Wikipedia*. Opaque algorithmic fraud detection falsely accused ~26,000 families; government fell (2020-21).
[^6]: Spolsky, Joel (2000). ["Things You Should Never Do, Part I"](https://www.joelonsoftware.com/2000/04/06/things-you-should-never-do-part-i/). *Joel on Software*. Netscape's rewrite cost 3 years and killed the company.
[^dilger]: Dilger, Martin (2023). [*Understanding Event Sourcing*](https://leanpub.com/understanding-eventsourcing). *Leanpub*. Accessible introduction to event sourcing concepts and patterns.
[^8]: Evans, Eric (2003). [*Domain-Driven Design*](https://www.domainlanguage.com/ddd/). Ubiquitous language, bounded contexts.
[^9]: Fowler, Martin. ["Event Sourcing"](https://martinfowler.com/eaaDev/EventSourcing.html). *martinfowler.com*. Complete audit log + temporal queries.
[^10]: Young, Greg (2010). ["CQRS Documents"](https://cqrs.files.wordpress.com/2010/11/cqrs_documents.pdf). Events as first-class citizens.
[^11]: Sweller, John (2011). ["Cognitive Load Theory"](https://en.wikipedia.org/wiki/Cognitive_load). *Wikipedia*. Design must respect working memory limits.
[^12]: Skelton, Matthew; Pais, Manuel (2019). [*Team Topologies*](https://teamtopologies.com/). Software boundaries should align with cognitive load limits. Popularized the "Inverse Conway Maneuver": design your org to get the architecture you want.
[^conway]: Conway, Melvin E. (April 1968). ["How Do Committees Invent?"](https://melconway.com/Home/Conways_Law.html). *Datamation*. "Any organization that designs a system will produce a design whose structure is a copy of the organization's communication structure."
[^14]: Fowler, Martin (2006). ["Ubiquitous Language"](https://martinfowler.com/bliki/UbiquitousLanguage.html). *martinfowler.com*. Shared vocabulary = code reads how business thinks.
[^16]: Steinberger, Peter (January 2026). ["GitHub contribution graph"](https://github.com/steipete?tab=overview&from=2026-01-01&to=2026-01-31). *GitHub*. 29,769 contributions in January 2026. See also: ["The creator of Clawd: I ship code I don't read"](https://newsletter.pragmaticengineer.com) (2025). *The Pragmatic Engineer*.
[^22]: paulmillr (2013). ["GitHub worldwide contributor leaderboard"](https://gist.github.com/paulmillr/2657075). *GitHub Gist*. TJ Holowaychuk (#1 globally): 7,458 contributions/year (Jan 2012–Jan 2013).
[^openclaw]: ["OpenClaw"](https://github.com/openclaw/openclaw). *GitHub*. Launched November 24, 2025. 270.4k stars as of March 2026, #12 all-time on GitHub, surpassing React (243.7k). Created by Steinberger, Peter ([@steipete](https://github.com/steipete)).
[^17]: Google (2024). ["Gemini 1.5 Technical Report"](https://arxiv.org/abs/2403.05530). *arXiv*. Demonstrated loading JAX codebase at 746,152 tokens in a single session.
[^18]: ["React (facebook/react)"](https://openhub.net/p/facebook-react). *Open Hub*. ~593,499 LOC, 88% JavaScript / 11% TypeScript.
[^19]: ["VS Code (microsoft/vscode)"](https://openhub.net/p/vscode). *Open Hub*. ~1,439,706 LOC, 97% TypeScript.
[^20]: ["Linux kernel surpasses 40 million lines"](https://www.stackscale.com/blog/linux-kernel-40-million-lines/) (January 2025). *Stackscale*. Linux 6.14 rc1: 40,063,856 total lines.
[^vsa]: ["Vertical Slice Architecture"](https://jimmybogard.com/vertical-slice-architecture/). *jimmybogard.com*. A module structure where features are organized as vertical slices through all layers of the stack rather than horizontal layers.
[^codecity]: Wettel, Richard; Lanza, Michele (2008). ["CodeCity: 3D Visualization of Large-Scale Software"](https://wettel.github.io/codecity.html). University of Lugano.
